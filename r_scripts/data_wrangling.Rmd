...
# FN_results_table_pivot <- reshape2::dcast(FN_results,  drug ~ gene, value.var = "wgs_id", fun.aggregate = length)
FN_results_table_pivot <- reshape2::dcast(FN_results, change ~ ., value.var = "wgs_id", fun.aggregate = length)
...
https://www.sciencedirect.com/science/article/pii/S2212553114001721
[@Hasan2015]
