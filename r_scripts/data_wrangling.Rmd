...
df <- setNames(data.frame(x = matrix(tab, ncol = ncol(tab))), dimnames(tab)[[2]])

df$cluster <- dimnames(tab)[[1]]

sum(rowSums(drop_cols(df, "cluster") == 0) == ncol(drop_cols(df, "cluster")) - 1)
