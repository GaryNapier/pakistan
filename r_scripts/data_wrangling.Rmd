...
or <- function(x, column){
  ...
  res_df <- data.frame(odds_ratio = test$estimate, 
...
or(dr_contingency_tab_df, "Pre-MDR"),
or(dr_contingency_tab_df, "MDR"),
or(dr_contingency_tab_df, "Pre-XDR"), 
or(dr_contingency_tab_df, "XDR"),
or(dr_contingency_tab_df, "Other")
),
...
or(loc_contingency_tab_df, "Hyderabad"), 
or(loc_contingency_tab_df, "Karachi"), 
or(loc_contingency_tab_df, "Lahore"), 
or(loc_contingency_tab_df, "Missing"), 
or(loc_contingency_tab_df, "Other"), 
or(loc_contingency_tab_df, "Peshawar"), 
or(loc_contingency_tab_df, "Rawalpindi"), 
...
gene_res_sort$CI <- paste0(CI_plus, "-", CI_minus)
...
```{r nusG-trees, echo=FALSE, out.width = "2000px", fig.height=3, dpi = 300, fig.show="hold", fig.cap = ""}
