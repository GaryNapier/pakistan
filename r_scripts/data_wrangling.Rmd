...
gwas_table <- gene_res_sort[1:5, c("rs", "beta", "log_p")]

gene_fun_lookup <- data.frame(rs = c("Rv2102", "Rv0914c", "nusG", "Rv2184c", "Rv1896c"), 
                              Function = c("Uncharacterised", 
                                           "Possible lipid carrier protein or keto acyl-CoA thiolase", 
                                           "Transcription termination/antitermination protein NusG", 
                                           "Uncharacterized", 
                                           "Putative S-adenosyl-L-methionine-dependent methyltransferase"))

gwas_table <- merge(gwas_table, gene_fun_lookup, by = "rs", all.x = T, sort = T)

gwas_table <- gwas_table[, c("rs", "Function", "beta", "log_p")]

names(gwas_table) <- c("Gene", "Function", "beta", "-log10 Wald p-value")
