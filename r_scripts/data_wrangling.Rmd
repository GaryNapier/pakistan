...
knitr::kable(dr_lin_tab, caption = "Drug resistance categories by lineage. See *Methods* section for criteria of categories.")

```

```{r drtable, echo=FALSE, out.width = "2000px"}

knitr::kable(dr_tab, align = align, caption = "Numbers and percentages of drug-resistant samples accourding to DST and genotypic predictions (TBprofiler)")
...
Pairwise SNP distances were calculated, revealing that 
